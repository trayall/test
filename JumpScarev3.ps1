...
$image =  "https://raw.githubusercontent.com/trayall/test/refs/heads/main/matt.png"

$i = -join($image,"?dl=1")
iwr $i -O $env:TMP\i.png

iwr https://raw.githubusercontent.com/trayall/test/refs/heads/main/matt.png?dl=1 -O $env:TMP\i.png
